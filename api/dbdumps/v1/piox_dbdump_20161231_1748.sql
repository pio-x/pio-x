...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 31. Dez 2016 um 17:48
...
CREATE TABLE `mrx_position` (
  ...
  `xpos_lat` float NOT NULL COMMENT 'mrx latitude',
  `xpos_long` float NOT NULL COMMENT 'mrx longitude',
...
(1, 47.5031, 8.73584, 1, '2016-12-31 16:11:27', 'Zu Fuss unterwegs zum Bus.'),
(2, 47.5048, 8.73686, 1, '2016-12-31 16:11:33', 'Nehme den Bus Nr.10'),
(3, 47.5079, 8.75811, 1, '2016-12-31 16:11:41', 'Nehme den Bus Nr.1'),
(4, 47.4986, 8.74888, 2, '2016-12-31 16:11:48', 'Nehme den Zug'),
(5, 47.4875, 8.76437, 2, '2016-12-31 16:11:55', 'Nehme den Bus Nr.2');
...
CREATE TABLE `r_team_riddle` (
  ...
  `img_ID` int(11) NOT NULL COMMENT 'team img of riddle'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `r_team_station` (
  ...
  `img_ID` int(11) NOT NULL COMMENT 'team img of station'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
